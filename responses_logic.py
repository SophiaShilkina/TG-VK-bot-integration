def message_handler(user_act=None, message=None):
    ...
    if message == '📆 изменить даты':
        return 'Хорошо, введите верные даты, соблюдая данный формат:\n\n❗дд.мм.гг – дд.мм.гг❗'
    ...
    if message == '👫 изменить соотношение':
        return 'Хорошо, введите верное соотношение, соблюдая данный формат:\n\n❗Число мужчин / число женщин❗'

    if message == '🏡 изменить комнаты':
        return 'Хорошо, введите верную комнату (верные комнаты), в которой Вы бы предпочли проживать в нашем заведении.'

    if message == 'все верно':
