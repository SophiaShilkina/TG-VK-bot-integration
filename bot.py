    ...
    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
        ...
        if message_text == 'начать':
            ...
            write_msg(event.user_id, '2⃣ Отлично, сколько гостей будет в вашей компании? 👔\n\n'
                                     ...
                                     'Просим обратить внимание, что в наш хостел заселяются дети'
                ...
                def check_callback_data(callback):
                    if callback.data == 'yes':
                        ...
                        write_msg(event.user_id,
                                  ...
                                  'рассмотреть другое время Вашего визита, пожалуйста, сообщите мне об этом, повторно '
                                  'нажав «Начать» и оставив заявку на другие даты, или попросите меня позвать оператора,'
